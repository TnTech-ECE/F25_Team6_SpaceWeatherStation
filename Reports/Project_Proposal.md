...
$$
S = \rho - 40.31 f^2 \int_A^B N\, ds = \rho - 40.3 (\text{TEC}) f^2 \tag{3}
$$
...
$$
n^2 = 1 - X(1 - iZ) - \frac{Y_T^2 (1 - X - iZ)}{2} \pm \frac{\sqrt{Y_T^4 (1 - X - iZ)^2 + Y_L^2}}{2} \tag{4}
$$
...
$$
n = 1 - \frac{X}{2} = 1 - \frac{f_N^2}{2 f^2} \tag{5}
$$
