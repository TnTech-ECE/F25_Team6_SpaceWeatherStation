...
- __Signal Quality__: - __Continuous Operating Duration and System Reliability__: The Continuous Operating Duration and System Reliability criterion was classified as a pass, as shown in Table [1]. The system was required to operate continuously for a minimum of 24 hours without interruption, failure, or data loss.
  ...
  &nbsp; &nbsp; &nbsp; &nbsp;During the initial test, system operation was maintained for the full 24-hour interval; however, signal quality was inconsistent due to indoor placement. Carrier-to-noise density ratio values were frequently low and exhibited significant variability, indicating poor signal reception conditions. While the system remained operational and continued logging data, the quality of the received signals was degraded under these conditions.

  &nbsp; &nbsp; &nbsp; &nbsp;In the follow-up outdoor test, the system again operated continuously for the full 24-hour interval without crashes, resets, or interruptions. Signal quality showed significant improvement, with values consistently exceeding 30 dB-Hz and many measurements reaching 40 dB-Hz or higher. This indicates reliable signal acquisition and stable operation under proper deployment conditions.
